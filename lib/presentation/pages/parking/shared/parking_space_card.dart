...
class ParkingSpaceCard extends StatelessWidget {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  Text(_getTypeEmoji(space.type), style: const TextStyle(fontSize: 20)),
                  const SizedBox(width: 8),
                  Text('${_getTypeLabel(space.type)} Space', style: theme.textTheme.bodyMedium),
                  const Spacer(),
  ...
  Widget _buildStatusBadge(BuildContext context) {
    ...
    if (space.status.toLowerCase() == 'vacant') {
